...
object PackageLicenseAdapter : JsonDeserializer<License> {
    ...
    override fun deserialize(
        ...
        return if (jsonObject.has("spdx_id")) {
            getLicenseOnSpdxIdOrNull(jsonObject["spdx_id"].asString)
                    ?: jsonDeserializationContext.deserialize(jsonElement, UnsupportedLicense::class.java)
        } else {
            jsonDeserializationContext.deserialize(jsonElement, UnsupportedLicense::class.java)
        }
    }
